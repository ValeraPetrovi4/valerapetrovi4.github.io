<html>
  ...
  <body>
    ...
    <div id="secret-doc" class="doc-sheet">
      ...
      <p><strong>Инцидент №:</strong> 5631</p>
      <p><strong>Дата:</strong> [УДАЛЕНО]</p>
      <p><strong>Статус:</strong> Активен.</p>
      <p><strong>Класс:</strong> Сорванный Маскарад</p>
      <hr>
      <p></p>
      <p></p>
      <p></p>
    ...
    <div id="secret-doc-2" class="doc-sheet">
      ...
      <p style="font-size: 11px; color: #666; margin-top: 20px; border-top: 1px solid #eee; padding-top: 10px;">
        Документ разрешен лица допуска 4+ и выше. В связи с раскрытием Фонда, данный документ обязан надежно хранится, пока амнезирование населения не завершится.
      </p>
    </div>
    <script>
