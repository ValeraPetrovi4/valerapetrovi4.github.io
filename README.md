<html>
  ...
  <body>
    ...
    <div id="secret-doc" class="doc-sheet">
      ...
      <p>SCP-5631-Ω - обозначение альтернативного измерения, далее именованное как "Ад" др. Сизифом. "Ад" представляет собой пустое пространство, т.е. не имеющее ни твердой поверхности, ни даже вакуума, несмотря на это, внешний наблюдатель (человек, видеоаппаратура и прочее) фиксирует красный оттенок "неба" измерения. </p>
    </div>
